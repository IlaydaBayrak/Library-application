...
# Form implementation generated from reading ui file 'kitapListesi.ui'
#
...
"    background-color: #ffffff;\n"
"}")
        self.tableKitapList = QtWidgets.QTableWidget(Form)
        self.tableKitapList.setGeometry(QtCore.QRect(20, 140, 961, 451))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.tableKitapList.setFont(font)
        self.tableKitapList.setObjectName("tableKitapList")
        self.tableKitapList.setColumnCount(7)
        self.tableKitapList.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.tableKitapList.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableKitapList.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableKitapList.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableKitapList.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableKitapList.setHorizontalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableKitapList.setHorizontalHeaderItem(5, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableKitapList.setHorizontalHeaderItem(6, item)
        self.tableKitapList.horizontalHeader().setDefaultSectionSize(137)
        self.leArama = QtWidgets.QLineEdit(Form)
        self.leArama.setGeometry(QtCore.QRect(20, 90, 231, 31))
        self.leArama.setObjectName("leArama")
        self.btnAra = QtWidgets.QPushButton(Form)
        self.btnAra.setGeometry(QtCore.QRect(270, 90, 91, 28))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(True)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("icons/icons8-search-32 (1).png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, Form):
        ...
        item = self.tableKitapList.horizontalHeaderItem(0)
        item.setText(_translate("Form", "ISBN NO"))
        item = self.tableKitapList.horizontalHeaderItem(1)
        item.setText(_translate("Form", "KİTAP ADI"))
        item = self.tableKitapList.horizontalHeaderItem(2)
        item.setText(_translate("Form", "KİTAP YAZARI"))
        item = self.tableKitapList.horizontalHeaderItem(3)
        item.setText(_translate("Form", "BASIM YILI"))
        item = self.tableKitapList.horizontalHeaderItem(4)
        item.setText(_translate("Form", "YAYINEVİ"))
        item = self.tableKitapList.horizontalHeaderItem(5)
        item.setText(_translate("Form", "DURUM"))
        item = self.tableKitapList.horizontalHeaderItem(6)
        item.setText(_translate("Form", "ÖDÜNÇ ALAN KİŞİ NO"))
        self.leArama.setPlaceholderText(_translate("Form", "Kitap/Yazar adı giriniz..."))
        self.btnAra.setText(_translate("Form", "ARA"))
        self.label.setText(_translate("Form", "♥ KİTAP LİSTESİ ♥"))
